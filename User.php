<?php
class User {
	private $dbHost     = "tsttodolist-mysqldbserver.mysql.database.azure.com";
    private $dbUsername = "mysqldbuser@tsttodolist-mysqldbserver";
    private $dbPassword = "Denny13735";
    private $dbName     = "dbtodolist";
